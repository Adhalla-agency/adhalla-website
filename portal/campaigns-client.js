export function createCampaignClient(fetcher=fetch) {
  ...
  async function call(path,body) {
    ...
    const timeout=setTimeout(()=>controller.abort(),['/pause','/preview','/regenerate','/help'].some(x=>path.endsWith(x))?95000:25000);
    try {
