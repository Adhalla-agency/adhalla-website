export function navigation(root,{current='business',clientId=null,worker=false,confirmed=true}={}){
 ...
 const items=[['profile','Ettevõtte info','index.html'],['business','Äri ülevaade','business.html'+query],['ads','Google Ads','campaigns.html'+query],['data','Andmed ja raportid','data.html'+query]];
